# 1 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
c-----------------------------------------------------------------------
...
# 12 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 12 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
C     
     ...
     $       ,IFBCOR
C     
# 13 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 13 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 14 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 14 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Metrics for 2D x tensor-product solver
     ...
     $               , bxyi (lx1,ly1,lelv)
      ...
      character*3      gtp_cbc
# 15 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 15 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Based on exact E operator, w/ correct velocity bc's in each direct
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 55 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 55 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 56 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 56 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Metrics for 2D x tensor-product solver
     ...
     $               , bxyi (lx1,ly1,lelv)
      ...
      common /gtpcbc/  gtp_cbc(6,0:ldimt1+1)
      character*3      gtp_cbc
# 57 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 57 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Set up array of element pointers
    ...
    2    format(i8,' problem in set_fast_eprec, lbw?',7i8)
      ...
      call gfdm_set_bc    (cb0,cbn,mfld)        !  Find tp-box bdry cond
      call gfdm_set_geom  (bw,nelx,nely,nelz)   !  Get 1D elem't lengths
      
      if (ifemat) call gfdm_set_genwz (nx1,nx2) !  Compute weights in WF
...
c     
c       
c    I   := K1-block-diagonal matrix of interpolation operators from M2 
c     GG
c     
c       
c    D   := K1-block-diagonal matrix of derivative operators from M2 to 
c     GG
c     
c     T 
c    Q   := K1 one-dimensional spectral element direct stiffness summati
c     I 
c     
c                                                             T
...
c     
c     
c *** NOTE that for symmetric boundary conditions ('S' := SYM ) the numb
c     of degrees-of-freedom for the velocity field in the D_GG term is n
c     while the number of degrees-of-freedom in the velocity field for t
c     I_GG term is n1p+1.   This is because the I_GG term operates on th
c     other *velocity* components (those tangential to the symmetry plan
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 346 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 346 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
C     
     ...
     $       ,IFBCOR
C     
# 347 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 347 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
C     
      common /comm_handles/ cr_h, gsh, gsh_fld(0:ldimt3), xxth(ldimt3)
      integer               cr_h, gsh, gsh_fld          , xxth
# 348 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 348 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Metrics for 2D x tensor-product solver
     ...
     $               , bxyi (lx1,ly1,lelv)
      ...
      common /gtpcbc/  gtp_cbc(6,0:ldimt1+1)
      character*3      gtp_cbc
# 349 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 349 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 416 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 416 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 417 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 417 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     
     ...
     $             ,  wglg  (lx1*lxq) , wglgt  (lx1*lxq)
      real ixd,ixdt,iggl,igglt
c     
# 418 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 418 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
c     
...
c     Gauss-Lobatto Legendre mesh (suffix M1)
      ...
      if (ifsplit) then
         call zwgll (zgp , wgp , nxp ) !  Pressure mesh weights and poin
      else
         call zwgl  (zgp , wgp , nxp ) !  Pressure mesh weights and poin
      endif
      ...
      call dgll (d1,d1t,zgl,nx,nx)     !  Generate 1st derivative matric
      call A1D (B1iA1,B1iA1t,d2,b2p,d1,d1t,wgl,nx) ! 2nd-order derivativ
      call set_diaga(da,dat,wgl,d1,bw,nx)          ! Diagonal of Laplaci
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 451 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 451 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 452 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 452 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
C     
      common /comm_handles/ cr_h, gsh, gsh_fld(0:ldimt3), xxth(ldimt3)
      integer               cr_h, gsh, gsh_fld          , xxth
# 453 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 453 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 454 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 454 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
c     
      character*1 cb0(3),cbn(3)
...
c     
      ...
      if (jnid.eq.nid) then
         ...
         do jf=1,ndim
            ...
            c   = cbc(iface,ie,ifld)
            icb(jf,1) = 1                !cb = 'N'
            if (c.eq.'v  '.or.c.eq.'V  ' .or.c.eq.'W  ') icb(jf,1)=2  ! 
            if (c.eq.'SYM'                             ) icb(jf,1)=3  ! 
            if (c.eq.'P  '                             ) icb(jf,1)=4  ! 
            if (c.eq.'DVN'                             ) icb(jf,1)=5  ! 
            if (c.eq.'DIV'                             ) icb(jf,1)=6  ! 
         enddo
      endif
c     
      ...
      if (jnid.eq.nid) then
         ...
         do jf=1,ndim
            ...
            c   = cbc(iface,ie,ifld)
            icb(jf,2) = 1                !cb = 'N'
            if (c.eq.'v  '.or.c.eq.'V  ' .or.c.eq.'W  ') icb(jf,2)=2  ! 
            if (c.eq.'SYM'                             ) icb(jf,2)=3  ! 
            if (c.eq.'P  '                             ) icb(jf,2)=4  ! 
            if (c.eq.'DVN'                             ) icb(jf,2)=5  ! 
            if (c.eq.'DIV'                             ) icb(jf,2)=6  ! 
         enddo
      endif
c     
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 554 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 554 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
C     
      ...
      REAL   ICM12,ICM21,ICTM12,ICTM21,ICM13,ICM31,ICTM13,ICTM31
      REAL   IAJL1,IATJL1,IAJL2,IATJL2,IALJ3,IATLJ3,IALJ1,IATLJ1
# 555 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 555 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 646 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 646 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
C     
     ...
     $       ,IFBCOR
C     
# 647 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 647 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 648 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 648 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Metrics for 2D x tensor-product solver
     ...
     $               , bxyi (lx1,ly1,lelv)
      ...
      common /gtpcbc/  gtp_cbc(6,0:ldimt1+1)
      character*3      gtp_cbc
# 649 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 649 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 717 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 717 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 718 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 718 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 789 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 789 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 790 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 790 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Metrics for 2D x tensor-product solver
     ...
     $               , bxyi (lx1,ly1,lelv)
      ...
      common /gtpcbc/  gtp_cbc(6,0:ldimt1+1)
      character*3      gtp_cbc
# 791 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 791 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Set up diagonal for pressure operator inversion via Fast Diag. Met
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 892 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 892 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
# 893 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 893 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
C     
      common /comm_handles/ cr_h, gsh, gsh_fld(0:ldimt3), xxth(ldimt3)
      integer               cr_h, gsh, gsh_fld          , xxth
# 894 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 894 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
...
c     Metrics for 2D x tensor-product solver
     ...
     $               , bxyi (lx1,ly1,lelv)
      ...
      common /gtpcbc/  gtp_cbc(6,0:ldimt1+1)
      character*3      gtp_cbc
# 895 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f" 2
# 895 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/gfdm_op.f"
