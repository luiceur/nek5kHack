# 1 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/mxm_std.f"
...
C     
      ...
      data    wdsize/0/
c     
c     First call: determine word size for dgemm/sgemm discrimination, be
c     
      if (wdsize.eq.0) then
         one = 1.0
         eps = 1.e-12
...
# 3937 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/mxm_std.f" 2
# 3937 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/mxm_std.f"
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 4032 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/mxm_std.f" 2
# 4032 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/mxm_std.f"
...
c automatically added by makenek
      parameter (lfdm=0)  ! == 1 for fast diagonalization method
# 4098 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/mxm_std.f" 2
# 4098 "/lustre/atlas/scratch/csep22/trn001/nek5_acc/nek_2013_11_27/mxm_std.f"
...
# 4129
      subroutine mxmf2_acc(A,N1,B,N2,C,N3)
c     
c     unrolled loop version 
c     
      real a(n1,n2),b(n2,n3),c(n1,n3)
      
      if (n2 .ne. 10 .AND. n2 .ne. 12) then
         write(*,*) " nnnn ", n1, n2,n3
         stop
      endif
      ...
      if (n2.le.8) then
         if (n2.eq.1) then
            call mxf1_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.2) then
            call mxf2_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.3) then
            call mxf3_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.4) then
            call mxf4_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.5) then
            call mxf5_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.6) then
            call mxf6_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.7) then
            call mxf7_acc(a,n1,b,n2,c,n3)
         else
            call mxf8_acc(a,n1,b,n2,c,n3)
         endif
      elseif (n2.le.16) then
         if (n2.eq.9) then
            call mxf9_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.10) then
            call mxf10_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.11) then
            call mxf11_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.12) then
            call mxf12_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.13) then
            call mxf13_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.14) then
            call mxf14_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.15) then
            call mxf15_acc(a,n1,b,n2,c,n3)
         else
            call mxf16_acc(a,n1,b,n2,c,n3)
         endif
      elseif (n2.le.24) then
         if (n2.eq.17) then
            call mxf17_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.18) then
            call mxf18_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.19) then
            call mxf19_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.20) then
            call mxf20_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.21) then
            call mxf21_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.22) then
            call mxf22_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.23) then
            call mxf23_acc(a,n1,b,n2,c,n3)
         elseif (n2.eq.24) then
            call mxf24_acc(a,n1,b,n2,c,n3)
         endif
      else
         call mxm44_0_acc(a,n1,b,n2,c,n3)
      endif
c     
      return
      end
c-----------------------------------------------------------------------
      subroutine mxf1_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,1),b(1,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf2_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,2),b(2,n3),c(n1,n3)
c     
!$ACC DATA PRESENT(a(:,1:2),b(:,1:n3), c(:,1:n3))
!$ACC PARALLEL LOOP
      do j=1,n3
         do i=1,n1
            c(i,j) = a(i,1)*b(1,j)
...
c-----------------------------------------------------------------------
      subroutine mxf3_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,3),b(3,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf4_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,4),b(4,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf5_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,5),b(5,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf6_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,6),b(6,n3),c(n1,n3)
c     
!$ACC DATA PRESENT(a(:,1:6),b(:,1:n3), c(:,1:n3))
!$ACC PARALLEL LOOP 
      do j=1,n3
         do i=1,n1
            c(i,j) = a(i,1)*b(1,j)
...
c-----------------------------------------------------------------------
      subroutine mxf7_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,7),b(7,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf8_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,8),b(8,n3),c(n1,n3)
c     
!$ACC DATA PRESENT(a(:,1:8),b(:,1:n3), c(:,1:n3))
!$ACC PARALLEL LOOP
      do j=1,n3
         do i=1,n1
            c(i,j) = a(i,1)*b(1,j)
...
c-----------------------------------------------------------------------
      subroutine mxf9_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,9),b(9,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf10_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,10),b(10,n3),c(n1,n3)
c     
!$ACC DATA PRESENT(a(:,1:10),b(:,1:n3), c(:,1:n3))
!$ACC PARALLEL LOOP 
      do j=1,n3
!$ACC LOOP
         do i=1,n1
...
c-----------------------------------------------------------------------
      subroutine mxf11_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,11),b(11,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf12_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,12),b(12,n3),c(n1,n3)
c     
!$ACC DATA PRESENT(a(:,1:12),b(:,1:n3), c(:,1:n3))
!$ACC KERNELS LOOP vector(16)
      do j=1,n3
!!$ACC LOOP
         do i=1,n1
            c(i,j) = a(i,1)*b(1,j)
...
c-----------------------------------------------------------------------
      subroutine mxf13_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,13),b(13,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf14_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,14),b(14,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf15_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,15),b(15,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf16_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,16),b(16,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf17_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,17),b(17,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf18_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,18),b(18,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf19_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,19),b(19,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf20_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,20),b(20,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf21_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,21),b(21,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf22_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,22),b(22,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf23_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,23),b(23,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxf24_acc(a,n1,b,n2,c,n3)
c     
      real a(n1,24),b(24,n3),c(n1,n3)
c     
      do j=1,n3
...
c-----------------------------------------------------------------------
      subroutine mxm44_0_acc(a, m, b, k, c, n)
c     
c matrix multiply with a 4x4 pencil 
c     
      real a(m,k), b(k,n), c(m,n)
